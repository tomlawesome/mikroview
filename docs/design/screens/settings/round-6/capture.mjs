// Screenshot round 6's scenes. Dark only -- round 30 (#708) removed the
// theme picker, so there is no light theme in the app to draw.
// Run from frontend/:
//   node ../docs/design/screens/settings/round-6/capture.mjs
...
const DIRECTIONS = [['r6', 'conditions-editor.html', ['s1', 's2', 's3', 's4']]];
