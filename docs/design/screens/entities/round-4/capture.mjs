// Screenshot round 4's scenes, dark and light. Run from frontend/:
//   node /tmp/wt489/docs/design/screens/entities/round-4/capture.mjs
...
const DIRECTIONS = [['ad', 'direction-ad-survey-instep.html', ['s1', 's2', 's3']]];
