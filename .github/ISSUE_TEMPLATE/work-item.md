...
<!-- What we are actually going to do, as of now. -->

## Why

<!-- The problem this solves. What breaks, or what is missing, if we don't. -->

## Superseded

<!--
  Anything previously planned here that is no longer the plan, one line
  each, with a pointer to the comment holding the reasoning. Delete this
  heading if nothing has been superseded yet.
-->
