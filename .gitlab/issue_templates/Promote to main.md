...
- [ ] any change since the last release to what the wizard sets on a router shipped with the cleanup for what it replaces (docs/routeros-setup.md's "Cleaning up an earlier setup" -- #1373)
