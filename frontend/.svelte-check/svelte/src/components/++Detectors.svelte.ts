...
async () => {
 ...
 { svelteHTML.createElement("div", { "class":`page scrollbar`,});
   ...
   { svelteHTML.createElement("div", { "class":`scope-primer`,});
   ...
   { svelteHTML.createElement("ul", { "class":`list`,});
       for(let d of __sveltets_2_ensureArray(detectorSettingsState.list)){d.name;
      const info = DETECTORS[d.name];
       { svelteHTML.createElement("li", { "class":`card`,});
         { svelteHTML.createElement("div", { "class":`card-main`,});
           { svelteHTML.createElement("label", { "class":`switch`,});
             { svelteHTML.createElement("input", {         "type":`checkbox`,"checked":d.enabled,"disabled":saving[d.name],"onchange":(e) => toggleEnabled(d.name, e.currentTarget.checked, d.scope),});}
             { svelteHTML.createElement("span", { "class":`name`,});info.label; }
           }
           { svelteHTML.createElement("p", { "class":`explanation`,});info.explanation; }
          if(errors[d.name]){
             { svelteHTML.createElement("p", { "class":`error`,});errors[d.name]; }
          }
         }

         { svelteHTML.createElement("div", { "class":`card-scope`,});
          if(SCOPE_FIELDS[d.name].length === 0){
             { svelteHTML.createElement("span", { "class":`scope-label`,});  }
             { svelteHTML.createElement("p", { "class":`no-scope`,});                      }
          }else{
             { svelteHTML.createElement("div", { "class":`scope-status`,});
               { svelteHTML.createElement("span", { "class":`scope-label`,});  }
               { svelteHTML.createElement("button", {   "class":`scope-toggle`,"onclick":() => toggleExpanded(d.name),});
                expanded === d.name ? 'Hide scope' : 'Edit scope';
               }
             }
            if(expanded !== d.name){
               { svelteHTML.createElement("p", { "class":`scope-summary`,});scopeSummary(d.scope); }
            }
          }

          if(expanded === d.name){
             { svelteHTML.createElement("div", { "class":`scope-section`,});
              if(info.scopeNote){
                 { svelteHTML.createElement("p", { "class":`scope-note`,}); { svelteHTML.createElement("strong", {});   } info.scopeNote; }
              }
              if(info.example){
                 { svelteHTML.createElement("p", { "class":`scope-example`,}); { svelteHTML.createElement("strong", {});  } info.example; }
              }

             { svelteHTML.createElement("div", { "class":`scope-form`,});
              if(SCOPE_FIELDS[d.name].includes('hosts')){
                 { svelteHTML.createElement("label", { "class":`field`,});
                   ...
                   { svelteHTML.createElement("div", { "class":`field-row`,});
                     { svelteHTML.createElement("select", { "bind:value":drafts[d.name].hostsMode,});/*Ωignore_startΩ*/() => drafts[d.name].hostsMode = __sveltets_2_any(null);/*Ωignore_endΩ*/
                       { svelteHTML.createElement("option", {"value":"",});  }
                       { svelteHTML.createElement("option", { "value":`allow`,});  }
                       { svelteHTML.createElement("option", { "value":`deny`,});  }
                     }
                     { svelteHTML.createElement("input", {      "type":`text`,"placeholder":`192.168.1.50, 203.0.113.0/24`,"bind:value":drafts[d.name].hosts,});/*Ωignore_startΩ*/() => drafts[d.name].hosts = __sveltets_2_any(null);/*Ωignore_endΩ*/}
                   }
                 }
              }
              if(SCOPE_FIELDS[d.name].includes('classification')){
                 { svelteHTML.createElement("label", { "class":`field`,});
                   { svelteHTML.createElement("span", {});  }
                   { svelteHTML.createElement("select", { "bind:value":drafts[d.name].classification,});/*Ωignore_startΩ*/() => drafts[d.name].classification = __sveltets_2_any(null);/*Ωignore_endΩ*/
                     { svelteHTML.createElement("option", {"value":"",});  }
              ...
              if(SCOPE_FIELDS[d.name].includes('ports')){
                 { svelteHTML.createElement("label", { "class":`field`,});
                   { svelteHTML.createElement("span", {});  }
                   { svelteHTML.createElement("div", { "class":`field-row`,});
                     { svelteHTML.createElement("select", { "bind:value":drafts[d.name].portsMode,});/*Ωignore_startΩ*/() => drafts[d.name].portsMode = __sveltets_2_any(null);/*Ωignore_endΩ*/
                       { svelteHTML.createElement("option", {"value":"",});  }
                       { svelteHTML.createElement("option", { "value":`allow`,});  }
                       { svelteHTML.createElement("option", { "value":`deny`,});  }
                     }
                     { svelteHTML.createElement("input", {      "type":`text`,"placeholder":`22, 3389`,"bind:value":drafts[d.name].ports,});/*Ωignore_startΩ*/() => drafts[d.name].ports = __sveltets_2_any(null);/*Ωignore_endΩ*/}
                   }
                 }
              }
              if(SCOPE_FIELDS[d.name].includes('rules')){
                 { svelteHTML.createElement("label", { "class":`field`,});
                   { svelteHTML.createElement("span", {});   }
                   { svelteHTML.createElement("div", { "class":`field-row`,});
                     { svelteHTML.createElement("select", { "bind:value":drafts[d.name].rulesMode,});/*Ωignore_startΩ*/() => drafts[d.name].rulesMode = __sveltets_2_any(null);/*Ωignore_endΩ*/
                       { svelteHTML.createElement("option", {"value":"",});  }
                       { svelteHTML.createElement("option", { "value":`allow`,});  }
                       { svelteHTML.createElement("option", { "value":`deny`,});  }
                     }
                     { svelteHTML.createElement("input", {      "type":`text`,"placeholder":`r13`,"bind:value":drafts[d.name].rules,});/*Ωignore_startΩ*/() => drafts[d.name].rules = __sveltets_2_any(null);/*Ωignore_endΩ*/}
                   }
                 }
              }
               { svelteHTML.createElement("div", { "class":`scope-actions`,});
                 { svelteHTML.createElement("button", {   "class":`cancel`,"onclick":() => (expanded = null),});  }
                 { svelteHTML.createElement("button", {     "class":`save`,"disabled":saving[d.name],"onclick":() => saveScope(d.name),});
...
const Detectors__SvelteComponent_ = __sveltets_2_fn_component($$render());
/*Ωignore_startΩ*/type Detectors__SvelteComponent_ = ReturnType<typeof Detectors__SvelteComponent_>;
/*Ωignore_endΩ*/export default Detectors__SvelteComponent_;